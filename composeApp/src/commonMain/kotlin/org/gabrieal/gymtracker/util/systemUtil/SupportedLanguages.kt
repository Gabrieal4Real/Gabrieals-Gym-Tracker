...
class EnglishStringResources : StringResources {
    ...
    override val recommendedSplit: String =
        "Based on your selected days, here's a recommended split just for you:"
    ...
    override fun xDayWorkoutxDayRest(workout: Int, rest: Int) =
        "$workout-day workout, $rest-day rest"
...
class MalayStringResources : StringResources {
    ...
    override val recommendedSplit: String =
        "Berdasarkan hari yang dipilih, ini adalah split yang sesuai untuk anda:"
    ...
    override fun xDayWorkoutxDayRest(workout: Int, rest: Int) =
        "$workout-hari latihan, $rest-hari istirahat"
...
class TamilStringResources : StringResources {
    ...
    override val howManyDays: String =
        "நீங்கள் எத்தனை நாட்கள் பயிற்சி செய்ய திட்டமிட்டிருக்கிறீர்கள்?"
    override val recommendedSplit: String =
        "உங்கள் தேர்ந்தெடுத்த நாட்களுக்கு ஏற்ப, இங்கே உங்கள் சிறப்பு பிரிப்பு:"
    ...
    override fun xDayWorkoutxDayRest(workout: Int, rest: Int) =
        "$workout-நாள் பிரிப்பு, $rest-நாள் ஓய்வு"
